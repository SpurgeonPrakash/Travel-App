...
import {
  saveTrip, cancelTrip, searchAndSave, getUpcomingTripsBrowser,
} from './js/trip';
...
document.getElementById('cancelTripButton').addEventListener('click', cancelTrip);
document.getElementById('scrollToAddTripButton').addEventListener('click', searchAndSave);
...
export {
  getGeonames, saveTrip, cancelTrip, searchAndSave,
};
